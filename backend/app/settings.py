...
def init_llamaAPI():
    ...
    api_key = "LL-AZq7XXdBAqTJq9V6DiFKMWg4vfnNrmRX7GjhCfgqnpcjmFbEhhkODAvk4Ghfa5ta"
    import os
    os.environ["LLAMAAPI_KEY"] = api_key
    ...
    print("settings variables updated")
